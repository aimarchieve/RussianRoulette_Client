...
const tableData = [
  ...
  { id: 15, name: 'tiger', lose: 6950.50, win: 47.05, color: '#f8bf60' },
  ...
  { id: 24, name: 'tiger', lose: 2500.50, win: 312.21, color: '#f8bf60' },
...
export default function TopWinnersSidebar(props) {
  ...
  return (
    <Stack spacing={0.5} sx={{ height: '82vh' }}>
      ...
      <Box p={1} borderRadius={1} className="bg-dark">
        <TableContainer sx={{ height: 577, overflow: 'hidden' }}>
          <Table>
            <TableBody>
              {
                    ...
                    >
                      <Stack direction="row" justifyContent="end">
                        <Stack>
                          ...
                          >
                            {dataItem.lose} <span className="text-yellow" style={{ fontSize: 13, fontFamily: "'Montserrat', sans-serif", paddingLeft: '3px', paddingRight: '4px' }} >x</span> 
                          </Typography>
                          <Typography
                            align="right"
                            color="white"
                            ...
                            sx={{ display: 'flex', alignItems: 'center', justifyContent: 'end' }}
                          >
                            {dataItem.win} <FontAwesomeIcon icon={faGem} className="text-yellow" fontSize={14} style={{ paddingLeft: '3px' }} />
                          </Typography>
                        </Stack>
                      </Stack>
                    </TableCell>
      ...
      <Box borderRadius={1} className="bg-dark">
        <Typography
          ...
          fontSize={14}
          fontFamily="'Montserrat', sans-serif"
          sx={{ display: 'flex', alignItems: 'center', justifyContent: 'center', textTransform: 'uppercase', paddingBottom: '5px', paddingTop: '5px' }}
        >
          mode
        </Typography>
        <Box
        ...
        >
          <TabsUnstyled defaultValue={0}>
            <TabsList>
              <Tab sx={{ fontFamily: 'Montserrat', textTransform: 'uppercase', borderRadius: '3px 0px 0px 3px' }} onClick={() => props.setGameMode("group")}>group</Tab>
              <Tab sx={{ fontFamily: 'Montserrat', textTransform: 'uppercase', borderRadius: '0px 3px 3px 0px' }} onClick={() => props.setGameMode("solo")} >solo</Tab>
            </TabsList>
          </TabsUnstyled>
        </Box>
      </Box>
