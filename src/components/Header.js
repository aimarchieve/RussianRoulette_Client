    ...
    <Stack sx={{ mt: {xs:2} }}>
      <Stack sx={{ mx: {lg:4, md:3, sm:2, xs:1} }}>
        ...
        <Stack direction="row" justifyContent="space-between" alignItems="center" sx={{ pb: 2 }}>
          ...
          <Grid container columns={10} sx={{ height: {lg:'35px', md:'30px', sm:'20px', xs:'10px'}, flexGrow: 1, pr: 2, width: '80%' }}>
            {
              [0, 1, 2, 3, 4, 5, 6, 7].map(itemIndex => (
                <Grid key={itemIndex} item md={1} xs={1} sx={{ px: {lg:1, md:1, sm:0.5, xs:0.3} }}>
        ...
        <Stack direction="row" justifyContent="space-between" alignItems="center" sx={{ pb: 1 }}>
          ...
          <Grid container columns={10} sx={{ height: {lg:'15px',md:'13px', sm:'10px', xs:'8px'}, pr: 0.8, width: '40%' }}>
            {
              [0, 1, 2, 3, 4, 5].map(itemIndex => (
                <Grid key={itemIndex} item md={1} xs={1} sx={{ px: {lg:0.5, md:0.4, sm:0.3, xs:0.2} }}>
                  <div className="bar-segment filled">
                    <div className="fill"></div>
                    <div className="bottom"></div>
                  </div>
          ...
          <Grid container columns={5} sx={{ height: {lg:'15px', md:'13px', sm:'10px', xs:'8px'}, pr: 0.8, width: '40%' }}>
            {
              [0, 1, 2].map(itemIndex => (
                <Grid key={itemIndex} item md={1} xs={1} sx={{ px: {lg:0.5, md:0.4, sm:0.3, xs:0.2} }}>
